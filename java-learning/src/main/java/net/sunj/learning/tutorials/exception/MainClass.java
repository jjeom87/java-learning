package net.sunj.learning.tutorials.exception;

public class MainClass {
	public static void main(String[] args) throws Exception {
		MainClass mainClass = new MainClass();

		System.out.println("============================== getLeaveWithoutChaining START ==============================");
		try {
			mainClass.getLeaveWithoutChaining();
		} catch (Exception e) {
			e.printStackTrace();
		}
		System.out.println("============================== getLeaveWithoutChaining END   ==============================");

		System.out.println("============================== getLeaveWithChaining START ==============================");
		try {
			mainClass.getLeaveWithChaining();
		} catch (Exception e) {
			e.printStackTrace();
		}
		System.out.println("============================== getLeaveWithChaining END   ==============================");
	}
