...
public class TimeExam {
  ...
  public static void main(String[] args) {
    // 날짜 가져오기
    System.out.println(LocalDate.now()); // 오늘
    System.out.println(LocalDateTime.now()); // 지금
    System.out.println(LocalDate.of(2015, 4, 17)); // 2015년4월17일
    System.out.println(LocalDateTime.of(2015, 4, 17, 23, 23, 50)); // 2015년4월17일23시23분50초
    System.out.println(Year.of(2015).atMonth(3).atDay(4).atTime(10, 30)); // 2015년3월4일 10시30분00초
    ...
    java.util.Date.from(LocalDateTime.now().atZone(ZoneId.systemDefault()).toInstant()); // Sat Apr 18 01:00:30 KST 2015

    // LocalDate -> java.sql.Date
    java.sql.Date.valueOf(LocalDate.of(2015, 5, 5)); // 2015-05-05
    ...
    new java.sql.Date(System.currentTimeMillis()).toLocalDate(); // 2015-04-18
